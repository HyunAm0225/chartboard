...
<!-- navbar 끝 -->
	...
	<%
		...
		Document doc = Jsoup.connect(url)
	            ...
	            .get();
		Elements album_imgs = doc.getElementsByClass("image_typeAll");
		Elements song = doc.getElementsByClass("ellipsis rank01");
		Elements singer = doc.getElementsByClass("ellipsis rank02");
		...
		for(int i=0; i<100;++i){
			...
			info.singer = singer.get(i).getElementsByTag("span").text();
