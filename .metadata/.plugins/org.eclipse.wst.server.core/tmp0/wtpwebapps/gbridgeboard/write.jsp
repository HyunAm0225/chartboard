...
<!-- navbar 끝 -->
	<div class="container">
		<div class="row">
				<form methd="post" action="writeAction.jsp">
				<table class="table table-dark" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						...
						<tr>
							<td><textarea type="text" class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2048" style="height:350px; width:500px;"></textarea></td>						
						</tr>
					</tbody>
				</table>
