...
<body>
	<%
		...
		if (userID == null) {
			...
			script.println("loction.href = 'login.jsp'");
			script.println("</script>");
		}
		...
		if (bbsID == 0) {
			...
			script.println("loction.href = 'bbs.jsp'");
			script.println("</script>");
		}
		...
		<div class="row">
			...
			<form method="post" action="updateAction.jsp?bbsID=<%= bbsID %>">
				<table class="table table-dark" style="text-align: center; border: 1px solid #dddddd;">
					<thead>
						<tr>
							<th colspan="2" style="text-align: center;">게시판
								글 수정 양식</th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							<td><textarea class="form-control" placeholder="글 내용"
									name="bbsContent" maxlength="2048" style="height: 350px; width:500px;"><%= bbs.getBbsContent() %></textarea></td>
